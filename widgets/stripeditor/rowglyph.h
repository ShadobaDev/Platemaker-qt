#ifndef STRIPEDIT_ROWGLYPH_H
#define STRIPEDIT_ROWGLYPH_H
 ...
 */
[[nodiscard]] QIcon objectGlyph(const TextArtifact& a, const QPalette& pal, int px = k_rowGlyphPx,
                                qreal dpr = 1.0);
